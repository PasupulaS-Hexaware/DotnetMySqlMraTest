using DotnetMysqlMraTest.Api.Installer;
using DotnetMysqlMraTest.Api.Middleware;
using DotnetMysqlMraTest.Data.Repositories;
...
using System;
using DotnetMysqlMraTest.Api.OpenTelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;
namespace DotnetMysqlMraTest.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "DotnetMysqlMraTest V1");
        });
