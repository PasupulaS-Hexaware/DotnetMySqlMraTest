...
DotnetMysqlMraTest.Api.Filters;
using DotnetMysqlMraTest.Business.Installer;
using System;
using OpenTelemetry.Exporter;
using OpenTelemetry.Exporter.OpenTelemetryProtocol;
using OpenTelemetry.Logs;
...
namespace DotnetMysqlMraTest.Api.Installer
{
    public class APIInstaller
{
    ...
    public void Install()
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "DotnetMysqlMraTest API", Version = version + "-" + branch });
        });
